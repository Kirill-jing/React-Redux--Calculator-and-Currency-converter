    ...
    const   StyledMenu = withStyles({
     ...
     <Main>
        ...
        <TextField  type='text' 
          InputLabelProps={{
          shrink: true,
          }}multiline value={this.props.calcRes}  
          label={this.props.ctr} >
        </TextField >
    <Grbtn>  
<MyButton onClick={()=>this.props.onAdd('3.1415926535897932384626433832795')}>{'\u03C0'}</MyButton>
...
<MyButton onClick={()=>this.props.DeleteOne(this.props.ctr.length-1)} >C</MyButton>
...
<StyledMenuItem  color="secondary" onClick={this.props.handleClose}>
<CustomLink to='/converter' exact>Converter</CustomLink>
  </StyledMenuItem>
</StyledMenu>
</Grbtn>
